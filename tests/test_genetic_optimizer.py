...
# Function moved outside for test_early_stopping
def constant_evaluate(individual):
    return (0.8,)
...
class TestGeneticOptimizer(unittest.TestCase):
    ...
    def test_crossover(self):
        ...
        offspring1, offspring2 = self.optimizer._cx_dict(individual1, individual2)
    ...
    def test_adjust_probabilities_increase(self):
        ...
        self.optimizer._adjust_probabilities(current_avg_fitness=0.905)
    ...
    def test_adjust_probabilities_decrease(self):
        ...
        self.optimizer.crossover_probability = 0.5
        self.optimizer.last_avg_fitness = 0.9
        self.optimizer._adjust_probabilities(current_avg_fitness=0.915)
