...
class Visualizer:
    ...
    def plot_fidelity_evolution(logbook):
        ...
        plt.fill_between(genetic_book["gen"], genetic_book["avg"] - genetic_book["std"], genetic_book["avg"] + genetic_book["std"], alpha=0.2, label="Standard Deviation")
    ...
    def plot_correlation(pop, parameters):
        ...
        for gate in parameters:
            ...
            plt.subplot(1, 2, 1)
            sns.scatterplot(x=f"{gate}_num_tslots", y="Fidelity", data=genetic_book_population)
            ...
            plt.subplot(1, 2, 2)
            sns.scatterplot(x=f"{gate}_evo_time", y="Fidelity", data=genetic_book_population)
    ...
    def plot_histogram_parameters(pop, parameters):
        ...
        for gate in parameters:
            plt.figure(figsize=(12, 5))
            plt.subplot(1, 2, 1)
            sns.histplot(genetic_book_population[f"{gate}_num_tslots"], bins=10, kde=True, color="green")
            ...
            plt.subplot(1, 2, 2)
            sns.histplot(genetic_book_population[f"{gate}_evo_time"], bins=10, kde=True, color="purple")
